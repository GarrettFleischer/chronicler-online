...
export const makeParseResult = (tokens, success = true, error = { expected: '', found: '' }, indentStack = [0], object = null) => ({ tokens, success, error, object, indent: indentStack }); // { level: indentLevel, check: isSameIndent } });
